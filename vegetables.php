...
<head>
    ...
    <title>Exito - Vegetables</title>
    <?php include("layout/header.php") ?>
</head>
<body>
    <?php include("layout/navbar.php") ?>
    <?php include("layout/bot.php") ?>
    <div class="container-fluid hero hero-vegetable py-5">
        <div class="container p-5 text-center">
            <h1 class="fw-bold text-white display-1">
                Vegetables - Side Dish
            </h1>
            <p class="text-white"><i>"Fresh from the farm, straight to your plate."</i></p>
        </div>
    </div>
<div class="container-fluid my-3 my-md-5 py-5">
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/vegetable/mixed.jpeg" alt="Buttered Mixed Veggies" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Buttered Mixed Veggies</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/vegetable/chopsuey.jpeg" alt="Chopysuey" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Chopysuey</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/vegetable/sauteed.jpeg" alt="Sauteed Peas, Carrots and Corn" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Sauteed Peas, Carrots and Corn</h3>
        </div>
    </div>
</div> 
