...
<head>
    ...
    <title>Exito - Salad</title>
    <?php include("layout/header.php") ?>
</head>
<body>
    <?php include("layout/navbar.php") ?>
    <?php include("layout/bot.php") ?>
    <div class="container-fluid hero hero-salad py-5">
        <div class="container p-5 text-center">
            <h1 class="fw-bold text-white display-1">
                Salad - Side Dish
            </h1>
            <p class="text-white"><i>"Fresh salad, fresh start."</i></p>
        </div>
    </div>
<div class="container-fluid my-3 my-md-5 py-5">
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/coleslaw.jpeg" alt="Coleslaw" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Coleslaw</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/caesar.jpeg" alt="Caesar Salad" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Caesar Salad</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/cucumber.jpeg" alt="Easy Cucumber Salad" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Easy Cucumber Salad</h3>
        </div>
    </div>
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/waldorf.jpeg" alt="Waldorf Style Potato Salad" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Waldorf Style Potato Salad</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/potato_chicken.jpeg" alt="Russian Style Potato Salad with Chicken" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Russian Style Potato Salad with Chicken</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/potato.jpeg" alt="Potato Salad with Pickle" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Potato Salad with Pickle</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/salad/garden.jpeg" alt="Garden Salad" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Garden Salad</h3>
        </div>
    </div>
</div> 
