...
<head>
    ...
    <title>Exito - Pasta</title>
    <?php include("layout/header.php") ?>
</head>
<body>
    <?php include("layout/navbar.php") ?>
    <?php include("layout/bot.php") ?>
    <div class="container-fluid hero hero-pasta py-5">
        <div class="container p-5 text-center">
            <h1 class="fw-bold text-white display-1">
                Pasta - Side Dish
            </h1>
            <p class="text-white"><i>"Grab a fork and twirl."</i></p>
        </div>
    </div>
<div class="container-fluid my-3 my-md-5 py-5">
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/baked_mac.jpeg" alt="Baked Macaroni" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Baked Macaroni</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/lasagna.jpeg" alt="Lasagna" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Lasagna</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/spag.jpeg" alt="Filipino Style Spaghetti" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Filipino Style Spaghetti</h3>
        </div>
    </div>
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/italian.jpeg" alt="Italian Style Spaghetti" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Italian Style Spaghetti</h3>
        </div> 
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/bacon_ham.jpeg" alt="Bacon and Ham Carbonara" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Bacon and Ham Carbonara</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/chicken.jpeg" alt="Chicken Carbonara" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Chicken Carbonara</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/pasta/tuna_carbonara.jpeg" alt="Tuna Carbonara" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Tuna Carbonara</h3>
        </div>
    </div>
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3">
            <img src="assets/pasta/canton.jpeg" alt="Canton Guisado" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Canton Guisado</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3">
            <img src="assets/pasta/bihon.jpeg" alt="Bihon Guisado" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Bihon Guisado</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3">
            <img src="assets/pasta/sotanghon.jpeg" alt="Sotanghon Guisado" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Sotanghon Guisado</h3>
        </div>
    </div>
</div> 
