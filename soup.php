...
<head>
    ...
    <title>Exito - Soup</title>
    <?php include("layout/header.php") ?>
</head>
<body>
    <?php include("layout/navbar.php") ?>
    <?php include("layout/bot.php") ?>
    <div class="container-fluid hero hero-soup py-5">
        <div class="container p-5 text-center">
            <h1 class="fw-bold text-white display-1">
                Soup - Side Dish
            </h1>
            <p class="text-white"><i>"Comfort yourself with our soothing and flavorful soup."</i></p>
        </div>
    </div>
<div class="container-fluid my-3 my-md-5 py-5">
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/soup/cream_mushroom.jpeg" alt="Cream of Mushroom" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Cream of Mushroom</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/soup/crab.jpeg" alt="Crab and Corn" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Crab and Corn</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/soup/corn.jpeg" alt="Cream and Corn" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Cream and Corn</h3>
        </div>
    </div>
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/soup/macaroni.jpeg" alt="Creamy Macaroni Soup" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Creamy Macaroni Soup</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/soup/sotanghon.jpeg" alt="Sotanghon" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Sotanghon</h3>
        </div>
    </div>
</div> 
