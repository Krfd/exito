...
<body>
    ...
    <div class="container-fluid hero hero-beverage py-5">
        <div class="container p-5 text-center">
            ...
            <p class="text-white"><i>"Sip with grace, savor with style."</i></p>
        </div>
    </div>
<div class="container-fluid my-3 my-md-5 py-5">
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/drinks/soda.jpeg" alt="Soda" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Soda</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/drinks/lemonade.jpeg" alt="Cucumber Lemonde" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Cucumber Lemonde</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/drinks/four_season.jpeg" alt="Four Season" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
            <h3 class="fw-semibold text-center">Four Season</h3>
        </div>
    </div>
</div> 
