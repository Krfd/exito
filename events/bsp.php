...
<?php include("layout/bot.php") ?>
    <div class="container d-flex flex-column flex-lg-row py-5">
        <form id="bsp" method="post" class="d-block mx-auto col-12 col-lg-8">
        <h1 class="fw-bold"><span class="green">Birthday</span> - Special</h1>
        <input type="hidden" name="key" value="<?php echo $key; ?>">
        <input type="hidden" name="token" value="<?php echo $token; ?>">
        <input type="hidden" name="event" value="Birthday Special">
            <div class="row">
                ...
                <div class="form-floating col-12 col-md-4 mt-3">
                    <input type="tel" name="phone" id="phone" class="form-control" minlength="11" maxlength="11" placeholder="Phone" autocomplete="off" required>
        ...
        <div class="py-3 py-md-5 px-md-3 px-lg-5 col-12 col-lg-4">
            ...
            <ul>
                ...
                <li>12 Delicious dishes</li>
                <li>5 Desserts</li>
                <li>4 Beverages</li>
                <li>Entertainer is included</li>
...
<script>
    $(document).ready(function() {
        $("#bsp").submit(function(e) {
            e.preventDefault();
            var bspData = $(this).serialize();
