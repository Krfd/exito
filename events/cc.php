...
<?php include("../layout/bot.php") ?>
    <div class="container d-flex flex-column flex-lg-row py-5">
        <form id="cc" method="post" class="d-block mx-auto col-12 col-lg-8">
        <h1 class="fw-bold"><span class="green">Corporate</span> - Classic</h1>
        <input type="hidden" name="key" value="<?php echo $key ?>">
        <input type="hidden" name="token" value="<?php echo $token ?>">
        <input type="hidden" name="event" value="Corporate Classic">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-floating col-12 col-md-3 mt-3">
                    <input type="price" name="price" id="price" class="form-control" placeholder="Price" value="20000" readonly>
                    <label for="price">Price</label>
                </div>
            </div>
            <textarea name="message" id="message" class="form-control mt-3" placeholder="You may enter your preferred main and side dish here..." autocomplete="off"></textarea>
