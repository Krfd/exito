    ...
    <div class="container d-flex flex-column flex-lg-row py-5">
        ...
        <input type="hidden" name="token" value="<?php echo $token ?>">
            ...
            <div class="row">
                ...
                <div class="form-floating col-12 col-md-3 mt-3">
                    <input type="price" name="price" id="price" class="form-control" placeholder="Price" value="20,000" readonly>
                    <label for="price">Price</label>
                </div>
            </div>
            <textarea name="message" id="message" class="form-control mt-3" placeholder="You may enter your preferred main and side dish here..."></textarea>
