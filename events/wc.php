...
<?php include("../layout/bot.php") ?>
    <div class="container d-flex flex-column flex-lg-row py-5">
        <form id="wc" method="post" class="d-block mx-auto col-12 col-lg-8">
        <h1 class="fw-bold"><span class="green">Wedding</span> - Classic</h1>
        <input type="hidden" name="key" value="<?php echo $key ?>">
        <input type="hidden" name="token" value="<?php echo $token ?>">
        <input type="hidden" name="event" value="Wedding Classic">
            <div class="row">
...
<script>
    $(document).ready(function() {
        $("#wc").submit(function(e) {
            e.preventDefault();
            var wcData = $(this).serialize();
