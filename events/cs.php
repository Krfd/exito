...
<head>
    ...
    <title>Corporate - Deluxe</title>
    <?php include("layout/header.php") ?>
</head>
<body>
<?php include("layout/navbar.php") ?>
    <div class="container d-flex flex-column flex-lg-row py-5">
        <form id="cs" method="post" class="d-block mx-auto col-12 col-lg-8">
        <h1 class="fw-bold"><span class="green">Corporate</span> - Special</h1>
        ...
        <input type="hidden" name="token" value="<?php echo $token ?>">
            ...
            <div class="row">
                ...
                <div class="form-floating col-12 col-md-3 mt-3">
                    <input type="price" name="price" id="price" class="form-control" placeholder="Price" value="30,000" readonly>
...
<script>
    $(document).ready(function() {
        $("#cs").submit(function(e) {
            e.preventDefault();
            var cdData = $(this).serialize();
