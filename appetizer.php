...
<div class="container-fluid hero hero-appetizer py-5">
        <div class="container p-5 text-center">
            ...
            <p class="text-white"><i>"Serving up deliciousness."</i></p>
        </div>
    </div>
<div class="container-fluid my-3 my-md-5 py-5">
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/cheese_sticks.jpeg" alt="Cheese Sticks" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">Cheese Sticks</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/fries.jpeg" alt="French Fries" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">French Fries</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/nachos.jpeg" alt="Nachos" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">Nachos</h3>
        </div>
    </div>
    <div class="container d-flex flex-column flex-md-row justify-content-center gap-3 my-3 my-md-5">
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/onion_rings.jpeg" alt="Onion Rings" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">Onion Rings</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/potato_ball.jpeg" alt="Potato Ball in Mozarella Cheese" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">Potato Ball in Mozarella Cheese</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/shanghai.jpeg" alt="Lumpia Shanghai" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">Lumpia Shanghai</h3>
        </div>
        <div class="w-100 rounded-3 shadow p-3" data-aos="fade-up">
            <img src="assets/appetizer/vege_shanghai.jpeg" alt="Vegetable Shanghai" class="w-100 object-fit-cover rounded-3 menu mb-2" style="height: 250px">
                <h3 class="fw-semibold text-center">Vegetable Shanghai</h3>
        </div>
    </div>
</div>
